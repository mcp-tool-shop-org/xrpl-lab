...
मार्गदर्शित लॉन्चर आपको वॉलेट सेटअप, फंडिंग और आपके पहले मॉड्यूल के बारे में बताता है।
...
तीन ट्रैक: शुरुआती, मध्यवर्ती और उन्नत, जिनमें से प्रत्येक में 12 मॉड्यूल हैं।
...
| 2 | विफलता ज्ञान | शुरुआती | जानबूझकर लेनदेन को विफल करें, निदान करें, ठीक करें, फिर से सबमिट करें | विफल + ठीक किए गए लेनदेन आईडी का क्रम |
...
| 10 | DEX मार्केट मेकिंग 101 | उन्नत | खरीद/बिक्री ऑफर, स्थिति स्नैपशॉट, सफाई | रणनीति लेनदेन आईडी + सफाई रिपोर्ट |
| 11 | इन्वेंट्री सुरक्षा | उन्नत | थ्रेशोल्ड-आधारित उद्धरण, केवल सुरक्षित-साइड प्लेसमेंट | इन्वेंट्री जांच + सुरक्षित लेनदेन आईडी |
...
सभी कमांड `--dry-run` का समर्थन करते हैं, जिसका उपयोग ऑफ़लाइन मोड में किया जा सकता है, जहां यह लागू होता है।

## प्रमाण

**प्रमाण पैक** (`xrpl_lab_proof_pack.json`): पूर्ण किए गए मॉड्यूल, लेनदेन आईडी और एक्सप्लोरर लिंक का साझा करने योग्य रिकॉर्ड। इसमें SHA-256 इंटीग्रिटी हैश शामिल है। कोई गुप्त जानकारी नहीं।

**प्रमाणपत्र** (`xrpl_lab_certificate.json`): पूर्णता का संक्षिप्त रिकॉर्ड।

**रिपोर्ट** (`reports/*.md`): आपने क्या किया और सिद्ध किया, इसका मानव-पठनीय सारांश।

**ऑडिट पैक** (`audit_pack_*.json`): SHA-256 इंटीग्रिटी हैश के साथ बैच सत्यापन परिणाम।

## सुरक्षा और विश्वास मॉडल

**XRPL लैब द्वारा उपयोग किया जाने वाला डेटा:**
