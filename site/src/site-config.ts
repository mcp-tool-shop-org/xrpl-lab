  ...
  sections: [
    ...
    },
    {
      ...
      rows: [
        ...
        ['Failure Literacy', 'foundations', 'failed + fixed txid trail'],
        ['Trust Lines 101', 'foundations', 'trust line + token balance'],
        ['Debugging Trust Lines', 'foundations', 'error → fix txid trail'],
        ['DEX Literacy', 'dex', 'offer create + cancel txids'],
        ['Reserves 101', 'reserves', 'before/after snapshot delta'],
        ['Account Hygiene', 'reserves', 'cleanup verification report'],
        ['Receipt Audit', 'audit', 'audit pack (MD + CSV + JSON)'],
        ['AMM Liquidity 101', 'amm', 'AMM lifecycle txids'],
