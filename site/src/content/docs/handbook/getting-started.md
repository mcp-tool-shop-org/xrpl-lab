...
<!-- BEGIN curriculum:auto getting-started-tracks -->
<!-- generated by scripts/gen_docs.py — do not hand-edit; run the generator -->
Modules are organized into ten tracks with explicit prerequisites (the order below matches `xrpl-lab list`):
...
<!-- END curriculum:auto getting-started-tracks -->
